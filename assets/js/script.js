...
(function () {
  ...
  const showResult = (result) => {
    ...
    switch (result) {
      case "you win":
        const playerPickContainer = document.querySelector(
          ".comparison__pick:first-child .picking"
        );
        playerPickContainer.classList.add("picking--winner");
        break;
      case "you lose":
        setTimeout(() => {
          const computerPickContainer = document.querySelector(
            ".comparison__pick:last-child .picking"
          );
  ...
  const showComputerPick = (computerPick) => {
    ...
    const computerPickContainerImg = computerPickContainer.querySelector(
